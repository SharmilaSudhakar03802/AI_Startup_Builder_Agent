...
import { Search, Palette, Monitor, Code2, Database, Megaphone } from 'lucide-react';

export const TABS = [
  { id: 'validation', label: 'Idea Validation', icon: Search, badge: 'Research Agent' },
  { id: 'branding', label: 'Brand & Identity', icon: Palette, badge: 'Branding Agent' },
  { id: 'landing', label: 'Live Landing Page', icon: Monitor, badge: 'UI Preview' },
  { id: 'frontend', label: 'React Frontend', icon: Code2, badge: 'Frontend Agent' },
  { id: 'backend', label: 'Backend APIs & DB', icon: Database, badge: 'Backend Agent' },
